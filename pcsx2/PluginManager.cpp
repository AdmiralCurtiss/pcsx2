...
void SysPluginBindings::McdReIndex( uint port, uint slot, uint sizeMB, bool allowFiltering, const wxString& filter ) {
	Mcd->McdReIndex( (PS2E_THISPTR) Mcd, port, slot, sizeMB, allowFiltering, filter );
}
